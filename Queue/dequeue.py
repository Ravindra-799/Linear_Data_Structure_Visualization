...
def initDequeue():
    ...
    g['lbl_capacity'] = Label(window, padx=15, font=(fontName, 15, "bold"), text="• Current Queue Capacity : " + str(capacity), justify=LEFT,bg = "powderblue")
    ...
    g['inp_get_txt'].pack(fill=BOTH,side=LEFT)
    ...
    g['lbl_error'] = Label(window, padx=15, font=(fontName , 15, "bold"), text="• Error : ", justify=LEFT, foreground="#dd2c00",bg = "powderblue")
