...
def initDynamicArray():
    ...
    inpUpdateIndex = entry(frame1, 15)
    entry_text(frame1, "Element :")
    inpUpdateElement = entry(frame1, 15)
    ...
    program = Label(window, text="• Program : ",font=("Courier New", 15, 'bold'))
...
def updateProgram(data):
    program.config(text="• Program : "+str(data), bg = "powderblue")
